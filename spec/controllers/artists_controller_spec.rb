...
RSpec.describe ArtistsController, type: :controller do
  ...
  describe "PUT #update" do
    context "with valid params" do
      it "updates the requested artst" do
      ...
      it "redirects to the created artst" do
        artist = create(:artist)
        put :update, {:id => artist.to_param, :artist => attributes_for(:artist, name: "New Name")}
  ...
  describe "GET #index" do
    it "assigns all artists as @artists and render the index template" do
      artist = create(:artist)
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "residrects to the created artist" do
        post :create, {:artist => attributes_for(:artist)}
